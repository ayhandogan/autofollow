 ...
 * Version: 2.0
 * Credits: Max (https://twitter.com/PupkinZade)
 * FUNCTIONS: Follow Back no bots and Direct Message
 */
...
foreach ($timeline as $statuses) { 
	...
	if($statuses->entities->urls[0]!=null && $statuses->entities->media[0]->media_url==null ) {$links_count++;}  // твиты с ссылками
	if($statuses->entities->media[0]->media_url!=null && $statuses->entities->media[0]->type=='photo') {$image_count++;} // твиты с изображениями
	if($statuses->entities->user_mentions[0]!=null) {$mention_count++;} // твиты с упомнинаниями
	}
